  ...
  return (
    <div className="container mx-auto pt-12 pb-16">
      <div className="m-2 max-w-4xl mx-auto">
        <div className="mb-5 border rounded-lg p-5 m-2 transition-colors duration-500 hover:bg-gray-100 cursor-pointer">
        ...
        <div className="mb-5 border rounded-lg p-5 m-2 transition-colors duration-500 hover:bg-gray-100 cursor-pointer">
          ...
          <div>
            ...
            <p className="mb-3">
              ...
              own prototype, making what&apos;s called a prototype chain. The
